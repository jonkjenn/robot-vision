...
class QTRSensors
{
  public:
    ...
    void read(std::vector<unsigned int> &sensor_values, unsigned char readMode = QTR_EMITTERS_ON);
    ...
    void readCalibrated(std::vector<unsigned int> &sensor_values, unsigned char readMode = QTR_EMITTERS_ON);
    ...
    int readLine(std::vector<unsigned int> &sensor_values, unsigned char readMode = QTR_EMITTERS_ON, unsigned char white_line = 0);
  ...
  protected:
    ...
    void init(std::vector<unsigned char> &pins, unsigned char emitterPin);

    std::vector<unsigned char> _pins;
    unsigned char _emitterPin;
    unsigned int _maxValue; // the maximum value returned by this function

  private:

    virtual void readPrivate(std::vector<unsigned int> &sensor_values) = 0;
...
class QTRSensorsRC : public QTRSensors
{
  public:
    ...
    QTRSensorsRC(std::vector<unsigned char> &pins,
    ...
    void init(std::vector<unsigned char> &pins,
  ...
  private:
    ...
    void readPrivate(std::vector<unsigned int> &sensor_values);
};
