...
class FirmataClass
{
  public:
    ...
    void begin();
    void begin(std::string port, LibSerial::SerialStreamBuf::BaudRateEnum speed);
    /* querying functions */
    void printVersion(void);
    void blinkVersion(void);
    void printFirmwareVersion(void);
    //void setFirmwareVersion(unsigned char major, unsigned char minor);  // see macro below
    void setFirmwareNameAndVersion(const char *name, unsigned char major, unsigned char minor);
    /* serial receive handling */
    int available(void);
    void processInput(void);
    /* serial send handling */
    void sendAnalog(unsigned char pin, int value);
    void sendDigital(unsigned char pin, int value); // TODO implement this
  ...
  private:
    ...
    unsigned char firmwareVersionCount;
    unsigned char *firmwareVersionVector;
    /* input message handling */
    unsigned char waitForData; // this flag says the next serial input will be data
    unsigned char executeMultiByteCommand; // execute this after getting multi-unsigned char data
    unsigned char multiByteChannel; // channel data for multiByteCommands
    unsigned char storedInputData[MAX_DATA_BYTES]; // multi-unsigned char data
    /* sysex */
